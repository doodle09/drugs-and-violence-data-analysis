...
top_drug_violence= drug_vs_violence.head(7)
fig,ax=plt.subplots(1,2,figsize=(15,4))
ax[0].scatter(top_drug_violence.index, top_drug_violence['drugs risk'],s=top_drug_violence['violence risk']*70,edgecolors='black')
ax[0].set_xlabel('locations')
ax[0].set_ylabel('drug & alcohol consumptions')
ax[0].text(1,32, ' buble size= violence , As drugs consumption increases the violence increases',fontsize=10,bbox=dict(alpha=0.5))
ax[0].set_title('Top 7 locations for drugs vs violence')
